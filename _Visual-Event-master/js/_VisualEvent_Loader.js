...
VisualEvent_Loader.prototype = {
	...
	"_construct": function ()
	{
		 ...
		 */
		this._loadFile( protocol+'css/VisualEvent.css', 'css' );

		if ( typeof jQuery == 'undefined' ) {
			this._loadFile( protocol+'js/VisualEvent-jQuery.js', 'js' );
		}
		else {
			this._loadFile( protocol+'js/VisualEvent.js', 'js' );
        ...
        // typeof jQuery == "undefined" ? this._loadFile(f + "//sprymedia.co.uk/VisualEvent/builds/VisualEvent-1398853496/js/VisualEvent-jQuery.js", "js") : this._loadFile(f + "//sprymedia.co.uk/VisualEvent/builds/VisualEvent-1398853496/js/VisualEvent.js", "js")
